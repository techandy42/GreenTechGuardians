...
def ask_questions_in_tree(problem, solution):
  ...
  categories_reasonings = categories_response.reasonings
  print(("=" * 10) + " CATEGORIES " + ("=" * 10))
  print(categories)

  return product, summary, embedded_value, embedded_value_reasoning, access_level, access_level_reasoning, processing_level, processing_level_reasoning, categories, categories_reasonings

# Test Cases
if __name__ == "__main__":
  import json

  product, summary, embedded_value, embedded_value_reasoning, access_level, access_level_reasoning, processing_level, processing_level_reasoning, categories, categories_reasonings = ask_questions_in_tree(
