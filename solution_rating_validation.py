...
index_name = 'greentechguardiansplus'
...
df2 = pd.read_csv('ValidationSet_AI_Earthhack - ValidationSet.csv', encoding="latin-1")

ratings = []
id = []
for a in strategy_score:
    id.append(a)
    ratings.append(strategy_score[a])

print(ratings)

df3 = df2.assign(id=id, ratings=ratings)
print(df3)