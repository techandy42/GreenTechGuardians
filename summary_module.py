...
def get_summary(problem, solution):
  sys_msg = None
  business_problem = f""" {problem} """
  business_solution = f""" {solution} """
  prompt = f"""
Given descriptions of a business problem in the circular economy and a corresponding business solution, give a summary of the business idea in less than 20 words.
