...
df = pd.DataFrame({'process':[0.1, 0.2, 0.3, 0.5, 0.1, 0.9], 'access':[0.4, 0.5, 0.7, 0.1, 0.9, 0.3], 
                   'strategy': ['a','b','c','b','e','a']})
fig = px.scatter(df,x = 'process', y = 'access',hover_data=['strategy'],  width=400, height=400)
fig.add_scatter(x=[0.2],
                y=[0.6],
                marker=dict(
                    color='red',
                    size=10
